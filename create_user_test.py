...
def negative_assert_symbol(first_name):
    ...
    # Проверяется, что в ответе есть поле 400
...
def test_create_user_russion_letter_in_first_name_get_success_response():
    positive_assert("Мария")


def test_create_user_space_letter_in_first_name_get_error_response():
